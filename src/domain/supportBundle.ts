...
export const formatSupportBundle = (bundle: SupportBundle, options: SupportBundleExportOptions = {}): string => {
  const formatted = [
    ...
    `- Native composition: ${bundle.summary.nativeCompositionStatus} / ${bundle.summary.nativeCompositionCoverage} / still-image ${bundle.summary.nativeCompositionStillImageOverlayCount} / text ${bundle.summary.nativeCompositionTextOverlayCount} / chat ${bundle.summary.nativeCompositionChatOverlayCount} / preview-only ${bundle.summary.nativeCompositionPreviewOnlySourceCount} / asset issues ${bundle.summary.nativeCompositionAssetIssueCount} / file-backed ${bundle.summary.nativeCompositionFileBackedAssetIssueCount}`,
