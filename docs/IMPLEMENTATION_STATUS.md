...
- Still-image VTuber face tracking runtime with native-camera frames on mobile, simulated frames on web, neutral calibration, dead-zone filtering, jump limiting, lost-face return tuning, image-aspect-aware geometry rig inference, browser alpha-mask foreground analysis for transparent/padded PNG auto-rigging, browser FaceDetector-to-semantic-landmark auto-rig handoff when available, detector/native ML landmark adapter contract, production rig-line diagnostics, support-bundle rig quality score/grade evidence, iOS/Android native compositor 2.5D motion scaling, tunable illustration rig regions, lightweight pseudo mesh deformation, hair/body follow-through, and eye/mouth deformation.
