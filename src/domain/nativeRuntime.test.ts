...
describe("native runtime audio telemetry", () => {
  it("normalizes PCM levels, counters, and timestamps", () => {
    const audio = normalizeNativeRuntimeAudioProcessing({
      ...
      encoderRecoveryAttemptCount: 2.6,
      encoderRecoverySuccessCount: 1.4,
      encoderRecoveryFailureCount: -1,
      encoderRecoverySuppressedInputBufferCount: 4.6,
      encoderRecoveryDroppedInputFrameCount: 959.6,
      encoderRecoveryDiscardedQueuedFrameCount: 1_024.4,
      encoderRecoveryConsecutiveFailureCount: 2.4,
      encoderRecoveryPending: true,
      encoderRecoveryRetryAfterMs: -100,
      encoderRecoveryLastStatus: -50.6,
      encoderRecoveryLastReason: "Authorization: Bearer audio-recovery-secret-token-value",
      encoderRecoveryLastRecoveryAt: 1_784_000_000_075.6,
    ...
    expect(audio).toMatchObject({
      ...
      encoderRecoveryFailureCount: 0,
      encoderRecoverySuppressedInputBufferCount: 5,
      ...
      encoderRecoveryPending: true,
      encoderRecoveryRetryAfterMs: 0,
      encoderRecoveryLastStatus: -51,
      encoderRecoveryLastReason: "Authorization: Bearer [redacted]",
      encoderRecoveryLastRecoveryAt: 1_784_000_000_076,
  ...
  it("provides conservative defaults for native versions without PCM metering", () => {
    expect(normalizeNativeRuntimeAudioProcessing(undefined)).toMatchObject({
      ...
      encoderRecoveryAttemptCount: 0,
      encoderRecoverySuccessCount: 0,
      encoderRecoveryFailureCount: 0,
      encoderRecoverySuppressedInputBufferCount: 0,
      encoderRecoveryDroppedInputFrameCount: 0,
      encoderRecoveryDiscardedQueuedFrameCount: 0,
      encoderRecoveryConsecutiveFailureCount: 0,
      encoderRecoveryPending: false,
      encoderRecoveryRetryAfterMs: 0,
      encoderRecoveryLastStatus: 0,
      encoderRecoveryLastReason: "",
      encoderRecoveryLastRecoveryAt: 0,
