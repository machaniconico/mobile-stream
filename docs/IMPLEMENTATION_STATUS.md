...
- Browser-preview Studio UI:
  ...
  - stream diagnostics panel with endpoint/quality/telemetry checks, JSON report export, and support bundle export
...
- React Native mobile stream diagnostics panel using the shared diagnostics model, including sanitized report and support bundle sharing.
