...
- Public YouTube and Twitch start locks block the mock engine, so an unlinked native LiveCaster module cannot be treated as a real platform-visible stream.
