...
- Private RTMP(S) validation runbook for setup, native start, stable monitor hold, destination dashboard check, clean stop, and retained evidence recording across diagnostics, support bundles, Web, and React Native.
