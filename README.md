...
- Physical validation evidence now retains mic FX/headphone monitor snapshots and YouTube/Twitch chat readout snapshots, and downgrades retained pass attempts when either commercial feature is not validated.
