...
- Face-tracking production diagnostics for prepared PNGTuber assets, native-camera readiness, tracking runtime state, active avatar motion, still-image rig quality score/grade, support bundles, and commercial validation checks.
