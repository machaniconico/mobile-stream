...
- Android native bridge for MediaProjection consent, foreground service streaming, H.264/AAC encoding, and RTMP/RTMPS publishing through RootEncoder, plus a first-party MediaCodec H.264/AAC configure probe exposed in native runtime telemetry.
...
- Encoding: VideoToolbox/AudioToolbox on iOS; Android now records a first-party MediaCodec H.264/AAC configure probe, but active RTMP publishing still reports RootEncoder until the Android publisher is moved to the direct MediaCodec path required for commercial release approval.
