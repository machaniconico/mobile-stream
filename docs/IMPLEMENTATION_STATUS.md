...
- Diagnostics reports and support bundles surface platform API audit counts, YouTube/Twitch dashboard status freshness, and YouTube broadcast privacy mismatch checks so release-candidate evidence can prove whether platform checks were current.
