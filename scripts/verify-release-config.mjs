...
const checks = [
  check("Android release signing uses production inputs", () => {
    ...
    expectIncludes(files.supportBundleDomain, "bundleVersion: 54");
    ...
    expectIncludes(files.commercialReleaseGateDomain, "const minimumSupportBundleVersion = 54");
    ...
    expectIncludes(files.commercialReleaseBundleScript, "const minimumSupportBundleVersion = 54");
