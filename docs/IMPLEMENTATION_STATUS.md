...
- Native composition readiness/diagnostics model that distinguishes native-supported avatar/image/solid/text/chat overlays from underlay ordering, Live2D/VRM production gaps, and iOS Broadcast Upload Extension still-image asset access risks before device RTMP publishing.
...
- Native VRM/VRoid 3D renderer integration, humanoid bone/expression mapping, and physical-device validation.
