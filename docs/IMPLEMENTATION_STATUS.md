...
- Local release-candidate verification command that chains native release-config checks, unit tests, web/RN typechecks, web build, browser UI verification, React Native iOS/Android bundles, and the commercial support-bundle gate.
