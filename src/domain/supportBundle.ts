...
export interface SupportBundle {
  ...
  summary: {
    ...
    lastSessionNativeRuntimeCompositionAppliedKinds: string[];
    ...
    lastSessionNativeRuntimeCompositorBackend: string;
    lastSessionNativeRuntimeCompositedFrameCount: number;
    lastSessionNativeRuntimeDroppedFrameCount: number;
    lastSessionNativeRuntimeCompositionFailureCount: number;
    lastSessionNativeRuntimeLiveRenderGraphReloadCount: number;
    lastSessionNativeRuntimeLiveRenderGraphRejectedUpdateCount: number;
    ...
    lastSessionNativeRuntimeLive2dSourceCount: number;
    lastSessionNativeRuntimeLive2dPosePayloadCount: number;
    lastSessionNativeRuntimeLive2dActivePoseCount: number;
    lastSessionNativeRuntimeLive2dMissingPoseCount: number;
    lastSessionNativeRuntimeLive2dRuntimeStatuses: string[];
    ...
    validationEvidenceAndroidPublisherModeAndroidPass: boolean;
    ...
    validationEvidenceLatestNativeRuntimeContinuityStatus: NonNullable<StreamDiagnostics["validationEvidence"]["latestNativeRuntime"]>["continuityStatus"] | null;
    validationEvidenceLatestNativeRuntimeVideoStallCount: number;
    ...
    validationEvidenceLatestNativeRuntimeCompositionAppliedKinds: string[];
    ...
    validationEvidenceLatestNativeRuntimeLiveRenderGraphReloadCount: number;
    validationEvidenceLatestNativeRuntimeLiveRenderGraphRejectedUpdateCount: number;
    ...
    validationEvidenceLatestNativeRuntimeLive2dSourceCount: number;
    validationEvidenceLatestNativeRuntimeLive2dPosePayloadCount: number;
    validationEvidenceLatestNativeRuntimeLive2dActivePoseCount: number;
    validationEvidenceLatestNativeRuntimeLive2dMissingPoseCount: number;
    validationEvidenceLatestNativeRuntimeLive2dRuntimeStatuses: string[];
    ...
    validationEvidenceLatestFaceTrackingLandmarkMotionScale: number;
    validationEvidenceLatestFaceTrackingFaceControlScale: number;
    ...
    validationEvidenceLatestFaceTrackingRigSemanticSegmentScore: number;
    validationEvidenceLatestFaceTrackingRigEyeMouthSegmentScore: number;
    validationEvidenceLatestFaceTrackingRigHorizontalAnchorScore: number;
    ...
    validationEvidenceLatestAudioOutputRoute: NonNullable<StreamDiagnostics["validationEvidence"]["latestAudio"]>["outputRoute"] | null;
    ...
    validationEvidenceLatestAudioNativeMonitorRoute: string | null;
    validationEvidenceLatestAudioNativeMonitorOutputName: string | null;
    validationEvidenceLatestAudioNativeMonitorRouteMatchesOutput: boolean;
    ...
    nativeCompositionNativeOverlayCount: number;
    nativeCompositionStillImageOverlayCount: number;
    nativeCompositionTextOverlayCount: number;
    nativeCompositionCaptionOverlayCount: number;
    nativeCompositionChatOverlayCount: number;
    ...
    nativeRuntimeContinuityStatus: string;
    ...
    nativeRuntimeAudioEncoderRecoveryAttemptCount: number;
    nativeRuntimeAudioEncoderRecoverySuccessCount: number;
    nativeRuntimeAudioEncoderRecoveryFailureCount: number;
    nativeRuntimeAudioEncoderRecoverySuppressedInputBufferCount: number;
    nativeRuntimeAudioEncoderRecoveryDroppedInputFrameCount: number;
    nativeRuntimeAudioEncoderRecoveryDiscardedQueuedFrameCount: number;
    nativeRuntimeAudioEncoderRecoveryConsecutiveFailureCount: number;
    nativeRuntimeAudioEncoderRecoveryPending: boolean;
    nativeRuntimeAudioEncoderRecoveryRetryAfterMs: number;
    nativeRuntimeAudioEncoderRecoveryLastStatus: number;
    nativeRuntimeAudioEncoderRecoveryLastReason: string;
    nativeRuntimeAudioEncoderRecoveryLastRecoveryAt: number;
    ...
    nativeRuntimeMonitorRecoveryCount: number;
    nativeRuntimeMonitorRecoveryFailureCount: number;
    nativeRuntimeMonitorLastRecoveryReason: string;
    nativeRuntimeMonitorLastRecoveryAt: number;
    nativeRuntimeMonitorSuspended: boolean;
    ...
    nativeRuntimeCompositorBackend: string;
...
export const createSupportBundle = ({
  ...
  const nativeRuntimeLive2dSourceCount = nativeRuntimeComposition?.live2dSourceCount ?? 0;
  ...
  return {
    ...
    summary: {
      ...
      lastSessionNativeRuntimeVideoEncoderBackend:
        diagnostics.session.lastSummary?.nativeRuntime?.videoEncoderBackend ?? "none",
      lastSessionNativeRuntimeAudioEncoderBackend:
      ...
      lastSessionNativeRuntimeCompositionAppliedKinds:
        diagnostics.session.lastSummary?.nativeRuntime?.compositionAppliedKinds ?? [],
      ...
      lastSessionNativeRuntimeCompositorBackend:
        diagnostics.session.lastSummary?.nativeRuntime?.runtimeCompositorBackend ?? "none",
      lastSessionNativeRuntimeCompositedFrameCount:
        diagnostics.session.lastSummary?.nativeRuntime?.runtimeCompositedFrameCount ?? 0,
      lastSessionNativeRuntimeDroppedFrameCount:
        diagnostics.session.lastSummary?.nativeRuntime?.runtimeDroppedFrameCount ?? 0,
      lastSessionNativeRuntimeCompositionFailureCount:
        diagnostics.session.lastSummary?.nativeRuntime?.runtimeCompositionFailureCount ?? 0,
      lastSessionNativeRuntimeLiveRenderGraphReloadCount:
        diagnostics.session.lastSummary?.nativeRuntime?.liveRenderGraphReloadCount ?? 0,
      lastSessionNativeRuntimeLiveRenderGraphRejectedUpdateCount:
        diagnostics.session.lastSummary?.nativeRuntime?.liveRenderGraphRejectedUpdateCount ?? 0,
      ...
      lastSessionNativeRuntimeLive2dSourceCount: diagnostics.session.lastSummary?.nativeRuntime?.live2dSourceCount ?? 0,
      lastSessionNativeRuntimeLive2dPosePayloadCount:
        diagnostics.session.lastSummary?.nativeRuntime?.live2dPosePayloadCount ?? 0,
      lastSessionNativeRuntimeLive2dActivePoseCount:
        diagnostics.session.lastSummary?.nativeRuntime?.live2dActivePoseCount ?? 0,
      lastSessionNativeRuntimeLive2dMissingPoseCount:
        diagnostics.session.lastSummary?.nativeRuntime?.live2dMissingPoseCount ?? 0,
      lastSessionNativeRuntimeLive2dRuntimeStatuses:
        diagnostics.session.lastSummary?.nativeRuntime?.live2dRuntimeStatuses ?? [],
      ...
      validationEvidenceAndroidPublisherModeAndroidPass: diagnostics.validationEvidence.androidPublisherModeAndroidPass,
      ...
      validationEvidenceLatestNativeRuntimeContinuityStatus:
        diagnostics.validationEvidence.latestNativeRuntime?.continuityStatus ?? null,
      validationEvidenceLatestNativeRuntimeVideoStallCount:
        diagnostics.validationEvidence.latestNativeRuntime?.videoStallCount ?? 0,
      validationEvidenceLatestNativeRuntimeAudioStallCount:
        diagnostics.validationEvidence.latestNativeRuntime?.audioStallCount ?? 0,
      validationEvidenceLatestNativeRuntimeMaxVideoStallDurationMs:
      ...
      validationEvidenceLatestNativeRuntimeEncoderProbeAudioBackend:
        diagnostics.validationEvidence.latestNativeRuntime?.encoderProbeAudioBackend ?? "none",
      ...
      validationEvidenceLatestNativeRuntimeCompositionAppliedKinds:
        diagnostics.validationEvidence.latestNativeRuntime?.compositionAppliedKinds ?? [],
      ...
      validationEvidenceLatestNativeRuntimeLiveRenderGraphReloadCount:
        diagnostics.validationEvidence.latestNativeRuntime?.liveRenderGraphReloadCount ?? 0,
      validationEvidenceLatestNativeRuntimeLiveRenderGraphRejectedUpdateCount:
        diagnostics.validationEvidence.latestNativeRuntime?.liveRenderGraphRejectedUpdateCount ?? 0,
      ...
      validationEvidenceLatestNativeRuntimeLive2dSourceCount:
        diagnostics.validationEvidence.latestNativeRuntime?.live2dSourceCount ?? 0,
      validationEvidenceLatestNativeRuntimeLive2dPosePayloadCount:
        diagnostics.validationEvidence.latestNativeRuntime?.live2dPosePayloadCount ?? 0,
      validationEvidenceLatestNativeRuntimeLive2dActivePoseCount:
        diagnostics.validationEvidence.latestNativeRuntime?.live2dActivePoseCount ?? 0,
      validationEvidenceLatestNativeRuntimeLive2dMissingPoseCount:
        diagnostics.validationEvidence.latestNativeRuntime?.live2dMissingPoseCount ?? 0,
      validationEvidenceLatestNativeRuntimeLive2dRuntimeStatuses:
        diagnostics.validationEvidence.latestNativeRuntime?.live2dRuntimeStatuses ?? [],
      ...
      validationEvidenceLatestFaceTrackingLandmarkMotionScale:
        diagnostics.validationEvidence.latestFaceTracking?.landmarkMotionScale ?? 1,
      validationEvidenceLatestFaceTrackingFaceControlScale:
        diagnostics.validationEvidence.latestFaceTracking?.faceControlScale ?? 0,
      ...
      validationEvidenceLatestFaceTrackingRigSemanticSegmentScore:
        diagnostics.validationEvidence.latestFaceTracking?.rigSemanticSegmentScore ?? 0,
      validationEvidenceLatestFaceTrackingRigEyeMouthSegmentScore:
        diagnostics.validationEvidence.latestFaceTracking?.rigEyeMouthSegmentScore ?? 0,
      validationEvidenceLatestFaceTrackingRigHorizontalAnchorScore:
        diagnostics.validationEvidence.latestFaceTracking?.rigHorizontalAnchorScore ?? 0,
      ...
      validationEvidenceLatestAudioOutputRoute: diagnostics.validationEvidence.latestAudio?.outputRoute ?? null,
      ...
      validationEvidenceLatestAudioNativeMonitorRoute: diagnostics.validationEvidence.latestAudio?.nativeMonitorRoute ?? null,
      ...
      validationEvidenceLatestAudioNativeMonitorRouteMatchesOutput:
        diagnostics.validationEvidence.latestAudio?.nativeMonitorRouteMatchesOutput ?? false,
      ...
      faceTrackingLandmarkMotionScale: diagnostics.faceTracking.landmarkMotionScale,
      faceTrackingFaceControlScale: diagnostics.faceTracking.faceControlScale,
      ...
      faceTrackingRigSemanticSegmentScore: diagnostics.faceTracking.rigSemanticSegmentScore ?? 0,
      faceTrackingRigEyeMouthSegmentScore: diagnostics.faceTracking.rigEyeMouthSegmentScore ?? 0,
      faceTrackingRigHorizontalAnchorScore: diagnostics.faceTracking.rigHorizontalAnchorScore ?? 0,
      ...
      nativeCompositionNativeOverlayCount: diagnostics.nativeComposition.nativeOverlayCount,
      nativeCompositionStillImageOverlayCount: diagnostics.nativeComposition.stillImageOverlayCount,
      nativeCompositionTextOverlayCount: diagnostics.nativeComposition.textOverlayCount,
      nativeCompositionCaptionOverlayCount: diagnostics.nativeComposition.captionOverlayCount,
      nativeCompositionChatOverlayCount: diagnostics.nativeComposition.chatOverlayCount,
      ...
      nativeRuntimeContinuityStatus: diagnostics.nativeRuntime?.continuity?.status ?? "unknown",
      nativeRuntimeVideoStallCount: diagnostics.nativeRuntime?.continuity?.videoStallCount ?? 0,
      ...
      nativeRuntimeAudioEncoderRecoveryAttemptCount:
        diagnostics.nativeRuntime?.audioProcessing?.encoderRecoveryAttemptCount ?? 0,
      nativeRuntimeAudioEncoderRecoverySuccessCount:
        diagnostics.nativeRuntime?.audioProcessing?.encoderRecoverySuccessCount ?? 0,
      nativeRuntimeAudioEncoderRecoveryFailureCount:
        diagnostics.nativeRuntime?.audioProcessing?.encoderRecoveryFailureCount ?? 0,
      nativeRuntimeAudioEncoderRecoverySuppressedInputBufferCount:
        diagnostics.nativeRuntime?.audioProcessing?.encoderRecoverySuppressedInputBufferCount ?? 0,
      nativeRuntimeAudioEncoderRecoveryDroppedInputFrameCount:
        diagnostics.nativeRuntime?.audioProcessing?.encoderRecoveryDroppedInputFrameCount ?? 0,
      nativeRuntimeAudioEncoderRecoveryDiscardedQueuedFrameCount:
        diagnostics.nativeRuntime?.audioProcessing?.encoderRecoveryDiscardedQueuedFrameCount ?? 0,
      nativeRuntimeAudioEncoderRecoveryConsecutiveFailureCount:
        diagnostics.nativeRuntime?.audioProcessing?.encoderRecoveryConsecutiveFailureCount ?? 0,
      nativeRuntimeAudioEncoderRecoveryPending:
        diagnostics.nativeRuntime?.audioProcessing?.encoderRecoveryPending ?? false,
      nativeRuntimeAudioEncoderRecoveryRetryAfterMs:
        diagnostics.nativeRuntime?.audioProcessing?.encoderRecoveryRetryAfterMs ?? 0,
      nativeRuntimeAudioEncoderRecoveryLastStatus:
        diagnostics.nativeRuntime?.audioProcessing?.encoderRecoveryLastStatus ?? 0,
      nativeRuntimeAudioEncoderRecoveryLastReason:
        diagnostics.nativeRuntime?.audioProcessing?.encoderRecoveryLastReason ?? "",
      nativeRuntimeAudioEncoderRecoveryLastRecoveryAt:
        diagnostics.nativeRuntime?.audioProcessing?.encoderRecoveryLastRecoveryAt ?? 0,
      ...
      nativeRuntimeMonitorRouteChangeCount:
        diagnostics.nativeRuntime?.audioProcessing?.monitorRouteChangeCount ?? 0,
      nativeRuntimeMonitorInterruptionCount:
        diagnostics.nativeRuntime?.audioProcessing?.monitorInterruptionCount ?? 0,
      nativeRuntimeMonitorRecoveryCount:
        diagnostics.nativeRuntime?.audioProcessing?.monitorRecoveryCount ?? 0,
      nativeRuntimeMonitorRecoveryFailureCount:
        diagnostics.nativeRuntime?.audioProcessing?.monitorRecoveryFailureCount ?? 0,
      nativeRuntimeMonitorLastRecoveryReason:
        diagnostics.nativeRuntime?.audioProcessing?.monitorLastRecoveryReason ?? "",
      nativeRuntimeMonitorLastRecoveryAt:
        diagnostics.nativeRuntime?.audioProcessing?.monitorLastRecoveryAt ?? 0,
      nativeRuntimeMonitorSuspended:
        diagnostics.nativeRuntime?.audioProcessing?.monitorSuspended ?? false,
      ...
      nativeRuntimeCompositorBackend: diagnostics.nativeRuntime?.composition.runtimeCompositorBackend ?? "none",
      nativeRuntimeCompositedFrameCount: diagnostics.nativeRuntime?.composition.runtimeCompositedFrameCount ?? 0,
      nativeRuntimeDroppedFrameCount: diagnostics.nativeRuntime?.composition.runtimeDroppedFrameCount ?? 0,
      nativeRuntimeCompositionFailureCount: diagnostics.nativeRuntime?.composition.runtimeCompositionFailureCount ?? 0,
      nativeRuntimeLiveRenderGraphReloadCount: diagnostics.nativeRuntime?.composition.liveRenderGraphReloadCount ?? 0,
      nativeRuntimeLiveRenderGraphRejectedUpdateCount: diagnostics.nativeRuntime?.composition.liveRenderGraphRejectedUpdateCount ?? 0,
      ...
      nativeRuntimeLive2dPosePayloadCount: diagnostics.nativeRuntime?.composition.live2dPosePayloadCount ?? 0,
      nativeRuntimeLive2dActivePoseCount: diagnostics.nativeRuntime?.composition.live2dActivePoseCount ?? 0,
      nativeRuntimeLive2dMissingPoseCount: diagnostics.nativeRuntime?.composition.live2dMissingPoseCount ?? 0,
      nativeRuntimeLive2dRuntimeStatuses: diagnostics.nativeRuntime?.composition.live2dRuntimeStatuses ?? [],
...
export const formatSupportBundle = (bundle: SupportBundle, options: SupportBundleExportOptions = {}): string => {
  const formatted = [
    ...
    `- Session incidents: ${bundle.diagnostics.session.historySummary.totalWarningEvents} warn / ${bundle.diagnostics.session.historySummary.totalFailureEvents} fail / ${bundle.diagnostics.session.historySummary.totalRecoveryEvents} recovery`,
    ...
    `- Last incidents: ${bundle.diagnostics.session.lastSummary?.warningCount ?? 0} warn / ${bundle.diagnostics.session.lastSummary?.failureCount ?? 0} fail / ${bundle.diagnostics.session.lastSummary?.recoveryEventCount ?? 0} recovery / ${bundle.diagnostics.session.lastSummary?.operationFailureCount ?? 0} operation failed`,
    ...
    `- Native audio encoder recovery: attempts ${bundle.summary.nativeRuntimeAudioEncoderRecoveryAttemptCount} / recovered ${bundle.summary.nativeRuntimeAudioEncoderRecoverySuccessCount} / failed ${bundle.summary.nativeRuntimeAudioEncoderRecoveryFailureCount} / consecutive ${bundle.summary.nativeRuntimeAudioEncoderRecoveryConsecutiveFailureCount} / pending ${bundle.summary.nativeRuntimeAudioEncoderRecoveryPending ? "yes" : "no"} / retry ${bundle.summary.nativeRuntimeAudioEncoderRecoveryRetryAfterMs}ms / suppressed buffers ${bundle.summary.nativeRuntimeAudioEncoderRecoverySuppressedInputBufferCount} / dropped input frames ${bundle.summary.nativeRuntimeAudioEncoderRecoveryDroppedInputFrameCount} / discarded queued frames ${bundle.summary.nativeRuntimeAudioEncoderRecoveryDiscardedQueuedFrameCount} / last ${bundle.summary.nativeRuntimeAudioEncoderRecoveryLastStatus} ${bundle.summary.nativeRuntimeAudioEncoderRecoveryLastReason || "-"} at ${bundle.summary.nativeRuntimeAudioEncoderRecoveryLastRecoveryAt || "-"}`,
