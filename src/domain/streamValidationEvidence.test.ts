...
const nativeMonitorRuntime = (platform: "ios" | "android" = "ios") => ({
  ...
  audioProcessing: {
    ...
    micCaptureStatus: platform === "android" ? "capturing" : "unavailable",
    micCaptureBackend: platform === "android" ? "android-audiorecord-microphone" : "none",
    micCaptureSampleRate: platform === "android" ? 44_100 : 0,
    micCaptureLifecycleEventCount: platform === "android" ? 2 : 0,
    micCaptureRouteChangeCount: platform === "android" ? 1 : 0,
    micCaptureInterruptionCount: platform === "android" ? 1 : 0,
    micCaptureRecoveryCount: platform === "android" ? 1 : 0,
    micCaptureRecoveryFailureCount: 0,
    micCaptureUnrecoveredEventCount: 0,
    micCaptureFallbackFrames: platform === "android" ? 882 : 0,
    micCaptureLastRecoveryReason: platform === "android" ? "capture-unsilenced" : "",
    micCaptureLastRecoveryAt: platform === "android" ? Date.parse("2026-06-23T00:00:03.500Z") : 0,
    ...
    playbackCaptureLifecycleEventCount: platform === "android" ? 2 : 0,
    playbackCaptureRouteChangeCount: platform === "android" ? 1 : 0,
    playbackCaptureInterruptionCount: platform === "android" ? 1 : 0,
    playbackCaptureRecoveryCount: platform === "android" ? 1 : 0,
    playbackCaptureRecoveryFailureCount: 0,
    playbackCaptureUnrecoveredEventCount: 0,
    playbackCaptureLastRecoveryReason: platform === "android" ? "route-changed" : "",
    playbackCaptureLastRecoveryAt: platform === "android" ? Date.parse("2026-06-23T00:00:03.600Z") : 0,
...
describe("stream validation evidence", () => {
  ...
  it("tracks iOS and Android face tracking coverage from retained passing runs", () => {
    ...
    expect(summary.runManifest.find((run) => run.devicePlatform === "android")).toMatchObject({
      ...
      nativeRuntimeMicCaptureFallbackFrames: 882,
      ...
      nativeRuntimeMicCaptureLastRecoveryAt: Date.parse("2026-06-23T00:00:03.500Z"),
      ...
      nativeRuntimePlaybackCaptureLastRecoveryAt: Date.parse("2026-06-23T00:00:03.600Z"),
