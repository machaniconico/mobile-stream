...
const formatSessionNativeRuntime = (summary: StreamSessionSummary): string =>
  summary.nativeRuntime
    ? `${summary.nativeRuntime.status} / ${summary.nativeRuntime.platform} / ${summary.nativeRuntime.publisherState || "-"} / queue ${summary.nativeRuntime.queuedItems}/${summary.nativeRuntime.cacheSize} / assets ${summary.nativeRuntime.stillImageAssetLoadedCount}/${summary.nativeRuntime.stillImageAssetCount} loaded / ${summary.nativeRuntime.stillImageAssetMissingCount} missing / vrm ${summary.nativeRuntime.vrmActivePoseCount}/${summary.nativeRuntime.vrmSourceCount} active payloads ${summary.nativeRuntime.vrmPosePayloadCount} missing ${summary.nativeRuntime.vrmMissingPoseCount} renderer ${summary.nativeRuntime.vrmRendererStatus} ${summary.nativeRuntime.vrmRenderedSourceCount}/${summary.nativeRuntime.vrmSourceCount} models ${summary.nativeRuntime.vrmModelLoadedCount} versions ${summary.nativeRuntime.vrmModelVersions.join("/") || "-"} bones ${summary.nativeRuntime.vrmHumanoidBoneCount} expressions ${summary.nativeRuntime.vrmExpressionCount} primitives ${summary.nativeRuntime.vrmMeshPrimitiveCount} skinned ${summary.nativeRuntime.vrmSkinnedMeshPrimitiveCount} joints ${summary.nativeRuntime.vrmSkinJointCount} morphs ${summary.nativeRuntime.vrmMorphTargetCount} pose bones ${summary.nativeRuntime.vrmPoseBoneAppliedCount}/${summary.nativeRuntime.vrmPoseBoneCount} pose expressions ${summary.nativeRuntime.vrmPoseExpressionAppliedCount}/${summary.nativeRuntime.vrmPoseExpressionCount} / drops ${summary.nativeRuntime.droppedVideoFrames} video ${summary.nativeRuntime.droppedAudioFrames} audio`
    : "-";
          ...
          ? `Native compositor could not load ${missingAssetCount} still-image asset${missingAssetCount === 1 ? "" : "s"}.`
            : missingVrmPoseCount > 0
              ...
              : incompleteVrmModelMetadata
                ...
                : incompleteVrmRenderability
                  ? "Native VRM model metadata is missing renderable mesh primitives, skinned meshes, or skin joints."
                  : incompleteVrmPoseMapping
