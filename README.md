...
- Public YouTube and Twitch start locks also block the mock engine, so a release build cannot silently treat an unlinked native LiveCaster module as a real platform-visible stream.
