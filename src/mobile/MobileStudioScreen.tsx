...
const sessionNativeRuntimeLabel = (summary: StreamSessionSummary): string =>
  summary.nativeRuntime
    ? `${summary.nativeRuntime.status} / ${summary.nativeRuntime.platform} / ${summary.nativeRuntime.publisherState || "-"} / queue ${summary.nativeRuntime.queuedItems}/${summary.nativeRuntime.cacheSize} / vrm ${summary.nativeRuntime.vrmActivePoseCount}/${summary.nativeRuntime.vrmSourceCount} active payloads ${summary.nativeRuntime.vrmPosePayloadCount} renderer ${summary.nativeRuntime.vrmRendererStatus} ${summary.nativeRuntime.vrmRenderedSourceCount}/${summary.nativeRuntime.vrmSourceCount} models ${summary.nativeRuntime.vrmModelLoadedCount} bones ${summary.nativeRuntime.vrmHumanoidBoneCount} expressions ${summary.nativeRuntime.vrmExpressionCount} primitives ${summary.nativeRuntime.vrmMeshPrimitiveCount} skinned ${summary.nativeRuntime.vrmSkinnedMeshPrimitiveCount} joints ${summary.nativeRuntime.vrmSkinJointCount} vertices ${summary.nativeRuntime.vrmVertexCount} indices ${summary.nativeRuntime.vrmIndexCount} skin attrs ${summary.nativeRuntime.vrmSkinningAttributePrimitiveCount} morphs ${summary.nativeRuntime.vrmMorphTargetCount} pose ${summary.nativeRuntime.vrmPoseBoneAppliedCount}/${summary.nativeRuntime.vrmPoseBoneCount} bones ${summary.nativeRuntime.vrmPoseExpressionAppliedCount}/${summary.nativeRuntime.vrmPoseExpressionCount} expressions / drops ${summary.nativeRuntime.droppedVideoFrames} video ${summary.nativeRuntime.droppedAudioFrames} audio`
...
const validationRunNativeRuntimeLabel = (run: StreamValidationRun): string | null =>
  run.nativeRuntime
    ? `native ${run.nativeRuntime.status} / ${run.nativeRuntime.platform} / publisher ${run.nativeRuntime.publisherState || "-"} / queue ${run.nativeRuntime.queuedItems}/${run.nativeRuntime.cacheSize} / vrm ${run.nativeRuntime.vrmActivePoseCount}/${run.nativeRuntime.vrmSourceCount} active payloads ${run.nativeRuntime.vrmPosePayloadCount} renderer ${run.nativeRuntime.vrmRendererStatus} ${run.nativeRuntime.vrmRenderedSourceCount}/${run.nativeRuntime.vrmSourceCount} models ${run.nativeRuntime.vrmModelLoadedCount} bones ${run.nativeRuntime.vrmHumanoidBoneCount} expressions ${run.nativeRuntime.vrmExpressionCount} primitives ${run.nativeRuntime.vrmMeshPrimitiveCount} skinned ${run.nativeRuntime.vrmSkinnedMeshPrimitiveCount} joints ${run.nativeRuntime.vrmSkinJointCount} vertices ${run.nativeRuntime.vrmVertexCount} indices ${run.nativeRuntime.vrmIndexCount} skin attrs ${run.nativeRuntime.vrmSkinningAttributePrimitiveCount} morphs ${run.nativeRuntime.vrmMorphTargetCount} pose ${run.nativeRuntime.vrmPoseBoneAppliedCount}/${run.nativeRuntime.vrmPoseBoneCount} bones ${run.nativeRuntime.vrmPoseExpressionAppliedCount}/${run.nativeRuntime.vrmPoseExpressionCount} expressions`
    : null;
