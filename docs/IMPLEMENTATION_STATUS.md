...
- Web and React Native Go Live areas show a shared public launch checklist covering destination/scene, platform dashboard freshness, chat readout, mic FX headphone monitoring, commercial evidence, and encoder state, with YouTube Public and Twitch starts locked when checklist warnings or failures remain while private/unlisted validation starts stay available.
