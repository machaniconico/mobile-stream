...
const minimumSupportBundleVersion = 56;
...
function nativeCaptionOverlaySummaryIssue(bundle) {
  ...
  return fail(
    ...
    "Export a support bundle v56 or newer so subtitle and live-caption overlays are retained separately from generic text overlay proof."
  );
}
...
function sceneFingerprintIssue(bundle) {
  ...
  if (!summaryFingerprint || !sceneFingerprint) {
    return fail(
      ...
      "Scene fingerprint",
      "Support bundle v56 is missing scene composition fingerprint evidence.",
...
function validationSceneManifestIssue(bundle) {
  ...
  return fail(
    ...
    "Record fresh iOS and Android validation runs from the exact scene composition intended for release, then export a v56 support bundle."
  );
}
...
function textOverlayEvidenceIssue(bundle) {
  ...
  if (!hasRequiredEvidence) {
    return fail(
      ...
      "Export a support bundle v56 or newer so visible manual text, subtitle, ticker, live-caption, native caption overlay kind proof, and avatar-overlap overlay evidence is summarized."
    );
  }
...
function chatOverlayEvidenceIssue(bundle) {
  ...
  if (!hasRequiredEvidence) {
    return fail(
      ...
      "Export a support bundle v56 or newer so visible chat overlay transparency, URL redaction, layout, safe-area, and avatar-overlap overlay evidence is summarized."
    );
  }
...
function liveCaptionEvidenceIssue(bundle) {
  ...
  if (!hasRequiredEvidence) {
    return fail(
      ...
      "Export a support bundle v56 or newer so live caption enablement, recognition state, source visibility, cue proof, and native caption overlay kind proof are summarized."
    );
  }
...
function validationManifestIssue(bundle) {
  ...
  if (!Array.isArray(manifest) || manifest.length === 0) {
    return fail(
      ...
      "Export a support bundle v56 or newer after retaining release-candidate validation runs."
    );
  }
  ...
  if (latestAndroidRun?.androidPublisherMode !== "mediacodec") {
    return fail(
      ...
      "Repeat Android physical validation with direct MediaCodec selected, then export a support bundle v56 or newer."
    );
  }
  ...
  if (
    ...
    return fail(
      ...
      "Export a support bundle v56 or newer after retaining iOS and Android validation runs with at least 60s / 3 samples of stable monitor telemetry including bitrate/FPS proof."
    );
  }
  ...
  if (
    ...
    return fail(
      ...
      "Export a support bundle v56 or newer after retaining iOS and Android validation runs with mic FX self-monitoring exercised through headphones and retained route-match latency source/budget/tuning proof."
    );
  }
  ...
  if (
    ...
    return fail(
      ...
      "Export a support bundle v56 or newer after retaining iOS and Android validation runs with fresh native-camera avatar motion, retained motion/control attenuation-scale proof, and ready PNGTuber rig quality/high-fidelity/semantic/eye-mouth/horizontal-anchor segment proof or native-rendered VRM proof."
    );
  }
  ...
  if (
    ...
    return fail(
      ...
      "Export a support bundle v56 or newer after retaining iOS and Android validation runs with YouTube/Twitch chat readout connection label/message proof and native/browser speech output exercised."
    );
  }
  ...
  if (
    ...
    return fail(
      ...
      "Export a support bundle v56 or newer after retaining iOS and Android validation runs with fresh YouTube/Twitch dashboard status, YouTube privacy/bound-stream proof, and Twitch title/category/language metadata from the destination receiving the stream."
    );
  }
