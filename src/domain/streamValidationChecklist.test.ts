...
const readyEvidence = (overrides: Partial<StreamValidationEvidenceSummary> = {}): StreamValidationEvidenceSummary => ({
  ...
  runManifest: [],
  requiredSceneFingerprint: "scene1-ready",
  requiredVideoWidth: 1280,
  requiredVideoHeight: 720,
  requiredVideoFps: 30,
  totalRuns: 2,
  eligibleRunCount: 2,
  staleRunCount: 0,
  ...
  warningCount: 0,
  failureCount: 0,
  physicalDeviceRunCount: 2,
  physicalDeviceReadyCount: 2,
  physicalDeviceWarningCount: 0,
  ...
  monitorHoldRunCount: 2,
  monitorHoldReadyCount: 2,
  monitorHoldWarningCount: 0,
  monitorHoldFailureCount: 0,
  ...
  platformIngestRunCount: 2,
  platformIngestReadyCount: 2,
  platformIngestWarningCount: 0,
  platformIngestFailureCount: 0,
