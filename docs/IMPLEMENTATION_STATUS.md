...
- Release-candidate validation evidence gating for freshness, current destination/protocol matching, same-build iOS/Android coverage, native publisher/compositor proof, stale evidence warnings, and support-bundle eligible/stale run counts.
