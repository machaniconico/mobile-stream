...
const checks = [
  check("Android release signing uses production inputs", () => {
    ...
    expectIncludes(files.supportBundleDomain, "bundleVersion: 20");
    expectIncludes(files.commercialReleaseGateDomain, "const minimumSupportBundleVersion = 20");
    expectIncludes(files.commercialReleaseBundleScript, "const minimumSupportBundleVersion = 20");
