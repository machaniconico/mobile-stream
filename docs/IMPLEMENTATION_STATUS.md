...
- Diagnostics reports and support bundles surface platform API audit counts and YouTube/Twitch dashboard status freshness so release-candidate evidence can prove whether platform checks were current.
