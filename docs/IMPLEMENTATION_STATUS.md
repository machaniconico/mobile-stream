...
- Browser-preview Studio UI:
  ...
  - stream diagnostics panel with endpoint/quality/telemetry/history checks, JSON report export, and support bundle export
...
- React Native mobile stream diagnostics panel using the shared diagnostics model, including health history, sanitized report sharing, and support bundle sharing.
