...
- Physical validation runs retain safe YouTube/Twitch dashboard evidence, including YouTube broadcast/stream/channel identity, YouTube broadcast/stream/health status, Twitch broadcaster/stream identity, Twitch live/offline status, and per-run dashboard freshness snapshots; unhealthy, stale, mismatched, or unchecked dashboard states downgrade retained validation outcomes.
