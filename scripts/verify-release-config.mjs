...
const checks = [
  check("Android release signing uses production inputs", () => {
    ...
    expectIncludes(files.commercialReleaseGateDomainTest, "recorded before the latest validation manifest evidence");
    ...
    expectIncludes(files.commercialReleaseBundleScriptTest, "recorded before the latest validation manifest evidence");
    ...
    expectIncludes(files.releaseEvidencePackageScript, "googleApiKeyPattern");
    expectIncludes(files.releaseEvidencePackageScript, "openAiApiKeyPattern");
    expectIncludes(files.releaseEvidencePackageScript, "githubTokenPattern");
    expectIncludes(files.releaseEvidencePackageScript, "jwtTokenPattern");
    expectIncludes(files.releaseEvidencePackageScript, "privateKeyBlockPattern");
    expectIncludes(files.releaseEvidencePackageScript, "sensitiveHeaderPattern");
    expectIncludes(files.releaseEvidencePackageScript, "sensitiveStructuredHeaderPattern");
    expectIncludes(files.releaseEvidencePackageScript, "contains a sensitive header value");
    expectIncludes(files.releaseEvidencePackageScript, "contains a structured sensitive header value");
    ...
    expectIncludes(files.commercialReleaseGateDomain, "googleApiKeyPattern");
    expectIncludes(files.commercialReleaseGateDomain, "openAiApiKeyPattern");
    expectIncludes(files.commercialReleaseGateDomain, "githubTokenPattern");
    expectIncludes(files.commercialReleaseGateDomain, "jwtTokenPattern");
    expectIncludes(files.commercialReleaseGateDomain, "privateKeyBlockPattern");
    expectIncludes(files.commercialReleaseGateDomain, "sensitiveHeaderPattern");
    expectIncludes(files.commercialReleaseGateDomain, "sensitiveStructuredHeaderPattern");
    ...
    expectIncludes(files.commercialReleaseBundleScript, "googleApiKeyPattern");
    expectIncludes(files.commercialReleaseBundleScript, "openAiApiKeyPattern");
    expectIncludes(files.commercialReleaseBundleScript, "githubTokenPattern");
    expectIncludes(files.commercialReleaseBundleScript, "jwtTokenPattern");
    expectIncludes(files.commercialReleaseBundleScript, "privateKeyBlockPattern");
