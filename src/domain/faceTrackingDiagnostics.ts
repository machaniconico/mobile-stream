...
export const createFaceTrackingDiagnostics = (
  ...
  if (rigAnalyses.length > 0 && rigHighFidelityGrade !== "ready") {
    return createWarning(
      ...
      "Tune hair, eye, mouth, shoulder, face range, semantic face/body segment coverage, explicit eye/mouth deformation bands, and slice count until parts, pseudo-depth continuity, semantic segments, and eye/mouth segments reach production-ready scores."
    );
  }
