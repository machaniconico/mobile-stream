...
- Physical validation run and evidence summaries include stable fingerprints across diagnostics panels and support bundles so release-candidate audit/support records can be correlated and accidental evidence mixups are easier to spot.
