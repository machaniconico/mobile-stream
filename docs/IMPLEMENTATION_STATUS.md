...
- Saved release-candidate report audit that revalidates archived RC reports against the current commit, clean git state, support-bundle SHA-256, browser UI evidence, generated artifact hashes, release-configuration input hashes, and required gate outcomes before commercial approval.
