...
- Physical validation runs retain mic FX/headphone monitor route, native self-monitor write/drop proof, and chat readout evidence, and unvalidated audio/chat states automatically downgrade retained validation outcomes.
