...
const checks = [
  check("Android release signing uses production inputs", () => {
    ...
    expectIncludes(files.supportBundleDomain, "bundleVersion: 53");
    ...
    expectIncludes(files.commercialReleaseGateDomain, "const minimumSupportBundleVersion = 53");
    ...
    expectIncludes(files.commercialReleaseBundleScript, "const minimumSupportBundleVersion = 53");
